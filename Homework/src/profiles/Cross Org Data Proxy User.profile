...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <classAccesses>
        <apexClass>ChangeContactsWhenBillingAddressUpdated</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>ChangeContactsWhichAreNotSynced</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>ChangeObjectsIfTaskIsNotSynced</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>PerformTaskAndContactBatch</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <fieldPermissions>
        <editable>false</editable>
        <field>Corporation__c.Annual_Revenue_Sum__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <layoutAssignments>
        <layout>Favorite__c-Favorite Name Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
